        ...
        <Link to="/details/:id">
          ...
          <SwiperSlide>
            ...
            <span className=" text-lg font-bold">
              ...
              Ministry of Information and Broadcasting of Bangladesh has
              recently authorised the registration
            </span>
          </SwiperSlide>
          <SwiperSlide>
            <img
          ...
          <SwiperSlide>
            ...
            <span className=" text-lg font-bold">
              Why must the poor be collateral damage of BNP-AL standoff? Why
              must the poor be collateral damage of BNP-AL standoff? Why must
              the poor be collateral damage of BNP-AL standoff?
            </span>
          </SwiperSlide>
        </Link>
      </Swiper>
